    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            <div class="topbar-logo-header">
                <div class="">
                    <img src="https://phuongnamvina.com/img_data/images/cach-thiet-ke-logo-bang-corel-13.jpg" class="logo-icon" alt="logo icon">
                </div>
                <div class="">
                    <h4 class="logo-text">NISA</h4>
                </div>
            </div>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="https://phuongnamvina.com/img_data/images/cach-thiet-ke-logo-bang-corel-13.jpg" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">NISA</p>
